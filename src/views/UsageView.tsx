    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          Plan limit bars with live Claude and Cursor sync.
        </p>
      </div>
      {plans.length === 0 ? (
        <EmptyState
          title="No usage plans yet"
          description="Load seed data from Settings to add Claude, Cursor, and manual plans."
